...
class Settings(BaseSettings):
    ...
    agent_chat_system_prompt: str = (
        ...
        "If they only ask which tool to use (no run request), answer in prose — do not launch scanners until they confirm. "
        "When they approve tools they previously rejected in a batch, call only those tools — never re-run scanners "
        "that already completed in the same session. "
