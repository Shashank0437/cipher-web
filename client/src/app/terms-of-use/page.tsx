...
export const metadata: Metadata = {
  title: "Terms of Use | CipherStrike",
  description: "Terms governing use of CipherStrike websites, demos, and software.",
};
...
export default function TermsOfUsePage() {
  return (
    ...
    >
      <p>
        These Terms of Use (&quot;Terms&quot;) describe the rules that apply when you access CipherStrike marketing sites,
      ...
      <p>
        CipherStrike is offensive-security automation software intended for authorized testing only. You may use the Services
      ...
      <p>
        Subject to compliance with these Terms, CipherStrike grants you a limited, revocable, non-exclusive, non-transferable
      ...
      <p>
        Depending on deployment, CipherStrike processes technical telemetry (targets, payloads, transcripts, artefacts, crash
      ...
      <p>
        CipherStrike may orchestrate third-party binaries (&quot;bring your own tools&quot;) under separate licenses issued by those
        vendors. You warrant that you comply with upstream license terms whenever agents invoke binaries you supply.
      </p>

      <h2 id="disclaimers">Disclaimers</h2>
      <p>
        THE SERVICES ARE PROVIDED &quot;AS IS&quot;. TO THE MAXIMUM EXTENT PERMITTED BY LAW, CIPHERSTRIKE DISCLAIMS WARRANTIES OF
      ...
      <p>
        TO THE EXTENT LAW ALLOWS, CIPHERSTRIKE&apos; TOTAL LIABILITY ARISING OUT OF THESE TERMS IS LIMITED TO THE FEES ACTUALLY
      ...
      <p>
        CipherStrike may update these Terms. Material changes may be surfaced within the Services or emailed to admins of
        customer accounts where applicable.
      </p>

      <h2 id="contact">Contact</h2>
      <p>
        Legal notices should be routed through channels published for your CipherStrike tenant or mailed to your assigned account
